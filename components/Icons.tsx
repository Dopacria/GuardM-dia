...
export const GuardMidiaLogo = ({ className }: { className?: string }) => (
...
export const TagIcon = ({ className }: { className?: string }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M7 7h.01M7 3h5a2 2 0 012 2v5a2 2 0 01-2 2H7a2 2 0 01-2-2V5a2 2 0 012-2z"></path><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M7 16.5A2.5 2.5 0 014.5 19a2.5 2.5 0 01-2.5-2.5A2.5 2.5 0 014.5 14a2.5 2.5 0 012.5 2.5z"></path></svg>
);
